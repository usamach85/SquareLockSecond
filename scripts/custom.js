...
//------------------------------------------------------------------------ 		
	$(window).scroll(function () {
        if ($(window).scrollTop() > $("nav").height()) {
            ...
            $("nav.navbar-slide").removeClass("top-white-menu");
             $(".change-onscale").attr("src", "./images/logoblack.png");
           
        } else {
            $("nav.navbar-slide").removeClass("show-menu");
             $("nav.navbar-slide").addClass("top-white-menu");
             $(".change-onscale").attr("src", "./images/logo.png");
